<template>
  <div class="container">
    <div :class="['doc-content', `n-doc-content--${currentPage}`]">
      <slot></slot>
    </div>
    <div v-if="currentPage && currentPage !== 'about'" class="github-item">
      <a :href="currentGithubUrl">
        <svg
          t="1584795147277"
          class="icon"
...
export default defineComponent({
  ...
  setup() {
    ...
    const currentPage = computed(() =>
      route.path ? route.path.split('/').slice(-1)[0] : route.name
    )

    const currentGithubUrl = computed(() => 'javascript:;')
